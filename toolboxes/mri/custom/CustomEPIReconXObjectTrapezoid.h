/** \file   CustomEPIReconXObjectTrapezoid.h
...
template <typename T> class CustomEPIReconXObjectTrapezoid : public EPIReconXObject<T>
{
 public:
  CustomEPIReconXObjectTrapezoid();
  virtual ~CustomEPIReconXObjectTrapezoid();
...
template <typename T> CustomEPIReconXObjectTrapezoid<T>::CustomEPIReconXObjectTrapezoid()
{
  rcvType_ = EVEN;
  balanced_ = true;
  rampUpTime_ = 0.0;
...
template <typename T> int CustomEPIReconXObjectTrapezoid<T>::computeTrajectory()
{
...
template <typename T> int CustomEPIReconXObjectTrapezoid<T>::apply(ISMRMRD::AcquisitionHeader &hdr_in, hoNDArray <T> &data_in, 
		    ISMRMRD::AcquisitionHeader &hdr_out, hoNDArray <T> &data_out)
{
...
template <typename T> float CustomEPIReconXObjectTrapezoid<T>::calcOffCenterDistance(ISMRMRD::AcquisitionHeader& hdr_in)
{
