/** \file   CustomGenericReconCartesianGrappaGadget.h
...
namespace Gadgetron {
    ...
    class EXPORTGADGETSMRICORE CustomGenericReconCartesianGrappaGadget : public GenericReconGadget
    {
    public:
        GADGET_DECLARE(CustomGenericReconCartesianGrappaGadget);

        typedef GenericReconGadget BaseClass;
        typedef Gadgetron::GenericReconCartesianGrappaObj< std::complex<float> > ReconObjType;

        CustomGenericReconCartesianGrappaGadget();
        ~CustomGenericReconCartesianGrappaGadget() override;
    ...
    protected:
        ...
        void save_complex_array_to_file_3d(hoNDArray<std::complex<float>> &array, int dim_1, int dim_2, int dim_3, const std::string& filepath);
    };
}
